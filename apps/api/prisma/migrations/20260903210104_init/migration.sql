...
-- CreateTable
CREATE TABLE "LocationHistoryPoint" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "LocationHistoryPoint_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "LocationHistoryPoint_userId_recordedAt_idx" ON "LocationHistoryPoint"("userId", "recordedAt");

-- CreateIndex
CREATE INDEX "LocationHistoryPoint_expiresAt_idx" ON "LocationHistoryPoint"("expiresAt");
...
-- AddForeignKey
ALTER TABLE "LocationHistoryPoint" ADD CONSTRAINT "LocationHistoryPoint_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
